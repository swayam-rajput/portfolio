        ...
        <main className="grow">
            <div className=" flex flex-col gap-16 pb-16"> 
                ...
                <div className="flex flex-col items-start gap-8 md:flex-row-reverse md:items-center md:justify-between">
                    <img alt="pfp"  fetchPriority="high" width='175' height='175' className="shadow-md aspect-square overflow-clip rounded-md object-cover" src="https://images.unsplash.com/photo-1472396961693-142e6e269027?q=80&w=256&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"/>
                    <div className="flex flex-col gap-1 mr-2">
                        ...
                        <div className="mt-8 flex items-center gap-10">
                            <a href="" className="flex flex-row">
                                <Button variant={'outline'} className="bg-transparent shadow-sm hover:bg-slate-100 dark:hover:bg-accent  border-slate-200 dark:border-slate-800">Resume
