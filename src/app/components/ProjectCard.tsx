        ...
        <div className="flex flex-col p-8 rounded-sm justify-between shadow hover:shadow-md border transition ">
            <div className="flex flex-col gap-2">
                <div className="img">
                    ...
                    <div className="title  font-medium text-lg mt-2 ">{title}</div>
                    ...
                    
                    {
                        link_url!==''?(
                            <Link target="_blank" href={link_url}>
                                ...
                                <Button className="md:h-8 group px-2.5 text-xs cursor-pointer shadow shadow-inherit  hover:bg-opacity-80 uppercase dark:hover:bg-opacity-70 font-medium group" variant={'default'} size={"sm"}>
                            ...
                            <Button className="md:h-8 px-2.5 text-xs " disabled variant={'default'}>{link}</Button>
