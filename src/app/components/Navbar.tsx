...
export const Navbar = () => {
    ...
    const [catShown, showCat] = useState(true)
    ...
    return (
        <header className="sticky top-0 z-50 sm:pt-4">            
            <div className="dark:bg-[#29292980]/25  bg-zinc-300/20 shadow-sm rounded-lg -mx-4 sm:-mx-8 px-4 pb-5 pt-6 backdrop-blur-md">
