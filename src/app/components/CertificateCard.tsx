...
const CertificateCard = ({
    title='',
    description='',
    image='https://images.unsplash.com/photo-1472396961693-142e6e269027?q=80&w=256&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    site='',
    link='',
    buttonText='View',
    buttonLink=''
    ...
    return (
        <div className="flex p-8 rounded-lg shadow hover:shadow-md transition border dark:border-accent">
            <div className="flex justify-between  flex-col md:flex-row-reverse flex-grow gap-4 md:gap-8">
                ...
                <div className="flex justify-end shrink-0 ">
                    <a target='_blank' className='flex' href={link}>
                        <img src={image} alt={title}  loading="eager" className="flex border dark:border-none border-gray-300 rounded-md outline-none md:h-44 w-full cursor-zoom-in  object-cover "/>
                    </a>
                </div>
                ...
                <div className="flex justify-between flex-col ">
                    ...
                    <div className='flex '>
                        <a target='_blank' className='flex' href={buttonLink}>
                            <Button className="px-2.5 h-8 text-xs shadow-sm shadow-inherit font-bold hover:bg-opacity-80 dark:hover:bg-opacity-70 dark:text-black text-white dark:bg-gray-100 bg-neutral-700 gap-1" variant={'default'} size={"sm"}>{buttonText}
