            ...
            <div className="flex justify-between  flex-col md:flex-row-reverse flex-grow gap-4 md:gap-8">
                ...
                <div className="flex justify-between flex-col ">
                    <div className='flex flex-col gap-3'>
                        <div className=" font-medium text-lg mt-2 ">{title}</div>
                    ...
                    <div className='flex '>
                        <a target='_blank' className='flex' href={buttonLink}>
                            <Button className="group px-2.5 h-8 text-xs shadow-sm shadow-inherit font-bold hover:bg-opacity-80 dark:hover:bg-opacity-70 dark:text-black text-white dark:bg-zinc-300 bg-zinc-700 tracking-wide " variant={'default'} size={"sm"}>{buttonText}
