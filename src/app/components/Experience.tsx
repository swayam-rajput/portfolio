    ...
    <div className="flex flex-col mx-1 mt-6  mb-6">
      ...
      >
        <Button
          ...
          className=" font-medium overflow-hidden data-[state=active]:bg-background dark:data-[state=active]:bg-muted data-[state=active]:text-foreground data-[state=active]:shadow data-[state=active]:opacity-100 opacity-70  transition-all duration-200 ease-out"
        >
          Work
        </Button>
