...
function HighlightItem({
  ...
  React.useImperativeHandle(ref as React.Ref<HTMLDivElement>, () => localRef.current!, []);
  const childRef = element?.props.ref;
  const composedRef = useComposedRefs<HTMLElement>(
    childRef,
    localRef as React.MutableRefObject<HTMLElement | null>,
